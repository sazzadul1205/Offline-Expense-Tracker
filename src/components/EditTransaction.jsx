...
export default function EditTransaction() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      ...
      <form onSubmit={handleSubmit} className="px-5 py-6 max-w-md mx-auto space-y-6">
        {/* Amount Card */}
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <button
                  ...
                  className={`py-3 rounded-xl font-medium transition ${formData.direction === 'owe_me'
                ...
                <button
                  ...
                  className={`py-3 rounded-xl font-medium transition ${formData.direction === 'i_owe'
        ...
        <div className="flex gap-3 pt-4 pb-20">
          ...
          <button
            ...
            className="flex-1 py-3 rounded-xl font-semibold text-white bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 transition-all active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {isProcessing ? (
